 ...
 * notified about an event. The {@link #preprocess(Class, List)} method will be
 * called by the {@link EventProvider} after collecting the targeted Listeners
 * for a certain event. Its result represents the Listeners to actually notify.
 *
...
public interface ListenerFilter {
    ...
    /**
     * Whether the modifications made by {@link #preprocess(Class, List)} retain
     * the original ordering of the passed in list.
     *
