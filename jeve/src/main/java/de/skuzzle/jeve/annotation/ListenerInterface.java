 ...
 * {@link de.skuzzle.jeve.Listener Listeners} in jeve. The corresponding annotation
 * processor performs some compile time checks for whether your listener adheres to the
 * general style of listener definitions in jeve.
 * 
 * <ul>
 *   <li>A listener should be defined as an interface</li>
 *   <li>The listener interface must extend {@link de.skuzzle.jeve.Listener Listener}</li>
...
public @interface ListenerInterface {
     ...
     * {@link de.skuzzle.jeve.Listener Listener} implementation. The default value is
     * {@link ListenerKind#NORMAL}.
     * 
