...
abstract class AbstractEventInvocation<L extends Listener, E extends Event<?, L>>
        implements EventInvocation {

    static final Logger LOG = LoggerFactory.getLogger(EventInvocation.class);
    ...
    protected AbstractEventInvocation(E event, L listener, ExceptionCallback ec,
    ...
    public final void notifyListener() {
        try {
            ...
            handleException(toFailedInvocation(e));
        }
    }
